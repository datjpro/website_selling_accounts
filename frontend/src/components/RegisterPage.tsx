...
const RegisterPage: React.FC<RegisterPageProps> = ({ onNavigate }) => {
  ...
  const [email, setEmail] = useState('baoloi@ ví dụ.com'); // Example error state from screenshot
    ...
    <div className="min-h-screen flex flex-col lg:flex-row bg-[#0f111a] text-white font-sans overflow-hidden">
        ...
        <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center bg-[#050608]">
             ...
             <div className="relative z-10 flex flex-col items-center">
                <div className="relative w-[500px] h-[500px] mb-8 animate-float">
                    {/* Placeholder for the gamepad image in the screenshot */}
                    <img 
                    ...
                    />
                    {/* Overlay Frame/Phone mockup approximation */}
                ...
                <h1 className="text-center text-4xl xl:text-5xl font-extrabold tracking-tight leading-tight drop-shadow-xl">
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">GAMEVAULT:</span> Gia nhập thế<br/>
                    giới game đỉnh cao.
                </h1>
             </div>
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 relative bg-[#13161f]">
            <div className="w-full max-w-[480px] bg-[#1a1f2e]/80 backdrop-blur-sm p-8 rounded-2xl shadow-2xl border border-white/5">
                <h2 className="text-2xl font-bold text-center mb-1 text-gray-100">Trang đăng ký</h2>
                ...
                <div className="space-y-3 mb-6">
                    <button className="w-full flex items-center justify-center gap-3 bg-[#242936] hover:bg-[#2e3545] border border-gray-700/50 rounded-lg py-3 transition-all group">
                        ...
                        <span className="text-sm font-medium text-gray-300 group-hover:text-white">Đăng ký bằng Google</span>
                    </button>
                    <button className="w-full flex items-center justify-center gap-3 bg-[#242936] hover:bg-[#2e3545] border border-gray-700/50 rounded-lg py-3 transition-all group">
                        <img src="https://www.svgrepo.com/show/475647/facebook-color.svg" alt="Facebook" className="w-5 h-5" />
                        <span className="text-sm font-medium text-gray-300 group-hover:text-white">Đăng ký bằng Facebook</span>
                    </button>
                </div>
                ...
                <form className="space-y-4">
                    <div>
                        <label className="block text-sm font-medium text-gray-400 mb-1.5">Tên người dùng</label>
                        <input 
                            type="text" 
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            className="w-full bg-[#2d1b1b]/50 border border-red-500/50 rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-red-500 transition-colors"
                        />
                         <p className="mt-1.5 text-xs text-red-400 flex items-center gap-1.5 font-medium">
                            <AlertCircle size={14} /> Địa chỉ email không hợp lệ. Vui lòng thử lại.
                        </p>
                    </div>

                    <div>
                        <label className="block text-sm font-medium text-gray-400 mb-1.5">Mật khẩu</label>
                    ...
                    <div className="flex items-center gap-3 pt-1">
                        <div className="relative flex items-center">
                           <input type="checkbox" id="terms" className="peer h-5 w-5 cursor-pointer appearance-none rounded border border-gray-600 bg-[#242936] checked:border-purple-500 checked:bg-purple-500 transition-all" />
                        ...
                        <label htmlFor="terms" className="text-sm text-gray-400 cursor-pointer select-none">Tôi đồng ý với <a href="#" className="text-blue-400 hover:text-blue-300 hover:underline">Điều khoản & Chính sách</a>.</label>
                    </div>
                ...
                <p className="mt-8 text-center text-sm text-gray-400">
                    Đã có tài khoản? <button onClick={() => onNavigate('login')} className="text-blue-400 hover:text-blue-300 font-medium hover:underline transition-colors">Đăng nhập</button>.
                </p>
            </div>
        </div>
    </div>
